...
""" quitamos la siguiente linea porque ya habiamos creado el servicio: app = FastAPI()"""
...
if __name__ == "__main__":
    uvicorn.run("services:app", host="0.0.0.0", port=8000) #cambiamos el llamado a la app a services:app